...
import com.lovo.fire_company.entity.CarEntity;
import com.lovo.fire_company.entity.LogEntity;
import com.lovo.fire_company.entity.PersonnelEntity;
import com.lovo.fire_company.entity.UserEntity;
import com.lovo.fire_company.service.CarService;
import com.lovo.fire_company.service.ILogService;
import com.lovo.fire_company.service.IUserService;
...
public class LogAspect {
     ...
     * 管理员登录方法的切入点
     */
    @Pointcut("execution(* com.lovo.fire_company.service.*.login*(..))")
     ...
     * 添加业务逻辑方法切入点
     */
    @Pointcut("execution(* com.lovo.fire_company.service.*.save*(..))")
     ...
     * 修改业务逻辑方法切入点
     */
    @Pointcut("execution(* com.lovo.fire_company.service.*.update*(..))")
     ...
     * 删除业务逻辑方法切入点
     */
    @Pointcut("execution(* com.lovo.fire_company.service.*.delete*(..))")
