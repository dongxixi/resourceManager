...
import com.lovo.fire_company.bean.PaginationBean;
import com.lovo.fire_company.dto.UserAllDto;
...
public class UserController {
    ...
    public String gotoLogin(HttpServletRequest request,HttpServletResponse response) {
        request.getSession().removeAttribute("roleNameFireCompany");
        return "login";
    }
    ...
    public String findBy(String userName, String password, HttpServletRequest request,HttpServletResponse response) {
        ...
        if (user != null && !"".equals(user)) {
            ...
            request.getSession().setAttribute("roleNameFireCompany", roleName);
